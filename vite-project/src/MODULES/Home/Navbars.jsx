      ...
      <div className="contener">
        <div className="left_side_navaction_bar">
          ...
          <div className="solutions_navigation" id="Why_orange_hrm_navigation">
            {/* <!-- Hear id is important for this navagation for   understandin but className for applying css in this negvation bar --> */}
            <div className="solution">
        ...
        <div className="Right_side_navaction_bar">
          <div>
            <button className="navigation_Butten1">
              <NavLink
                to="/Login"
                //hear we can also add some styling using is Active but it is not happen in Link
