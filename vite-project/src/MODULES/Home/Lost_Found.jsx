  ...
  return (
    <div className="container_Lost_found">
      <div className="headers">
        <h1>Lost & Found</h1>
        <p>Did you lose valuables inside the airport premises? Tell us about it, so that we can find it for you.</p>
      </div>
      <div className="search-bar1">
        ...
        <a href="http://localhost:5502/FRANTENTS/HTML/LOSE%26FOUND.html"><button
          className="search-button">→</button></a>
