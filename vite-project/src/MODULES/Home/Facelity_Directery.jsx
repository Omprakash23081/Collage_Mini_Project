  ...
  return (
    <div className="container1">
      ...
      <div className="search-bar1" id="search-bar">
        <input type="text" placeholder="Faculty Name" className="input-department" />
        ...
        <a href="http://localhost:5502/FRANTENTS/HTML/FACALITY_DIRECATORY.html"><button
          className="search-button">Search</button></a>
      </div>
