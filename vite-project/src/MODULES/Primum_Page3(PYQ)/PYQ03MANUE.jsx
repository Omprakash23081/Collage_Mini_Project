  ...
  return (
    <>
      <div className={style.categories}>
        <div
          className={`${style.category_card} ${currentquestion === "Beginner" && style.actives
            } `}
        ...
        <div
          className={`${style.category_card} ${currentquestion === "Target Mains" && style.actives
            } `}
          onClick={() => set1("Target Mains")}
        >
          <div className={style.category_title}>Target Mains</div>
          <div className={style.category_icon}>
            <img
        ...
        <div
          className={`${style.category_card} ${currentquestion === "Advance Climb" && style.actives
            } `}
