import style from "./ChapContHEADER.module.css";

function ChapContHEADER({ setcontents, currentsubject }) {
  function set(value) {
    setcontents(value);
  }
  return (
    <header className={style.header}>
      ...
      <div className={style.header_content}>
        <h1 className={style.header_title}>{currentsubject}</h1>
        <div className={style.header_subtitle}>High Output High Input</div>
      </div>
