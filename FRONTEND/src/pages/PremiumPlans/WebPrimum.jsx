    ...
    try {
      const response = await planService.getPlans();
            ...
            if (Array.isArray(plansData) && plansData.length > 0) {
                const defParams = plansData.find(p => p.name === 'Premium') || plansData[0];
    ...
    <>
      <div className={style.pricing_container} id={style.body}>
        <div className={style.innerContainer}>
          ...
          <a href="#" className={`${style.cta_button} ${currentPrice === 'Basic' ? style.btnBasic : currentPrice === 'Super' ? style.btnSuper : style.btnPremium}`}>
